...
_No active goal. Start one by updating this file and invoking `/planning-with-files "Goal #N: Description"`._
...
3. Invoke `/planning-with-files "Goal #N: Description"` to create:
